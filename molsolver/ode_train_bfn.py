...
if __name__ == "__main__":
    ...
    parser.add_argument("--sigma1_coord", type=float, default=0.005) 
    parser.add_argument("--beta1", type=float, default=0.8)  
    parser.add_argument("--t_min", type=float, default=0.0001)
    parser.add_argument("--use_discrete_t", type=eval, default=False)  
    ...
    parser.add_argument(
        "--sampling_strategy", type=str, default="end_back_pmf", choices=["vanilla", "end_back_pmf"]
    )  # vanilla or end_back

    parser.add_argument("--time_emb_mode", type=str, default="simple", choices=["simple", "sin", "rbf", "rbfnn"])
    ...
    parser.add_argument("--sample_method", type=str, default="odesample", choices=["sample", "odesample"])
    # parser.add_argument("--sample_mood", type=str, default="", choices=["sample", "odesample"])
